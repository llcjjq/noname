game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"天赐拓展",content:function(config,pack){
    ...
    skill:{
            ...
            "冯冯杀":{
                ...
                content:function(){
                    ...
                    if(result.control=="反转比较"){
                        player.storage.冯冯杀_反转比较=!player.storage.冯冯杀_反转比较;
                        player.popup("反转比较");
                    }
                ...
                init:function(player,skill){
                    player.storage[skill+"_反转比较"]=player.storage[skill+"_反转比较"]||false;
                    player.storage[skill+"_移除开始"]=player.storage[skill+"_移除开始"]||false;
                    player.storage[skill+"_移除结束"]=player.storage[skill+"_移除结束"]||false;
                },
                ai:{
                    threaten:2,
                },
        ...
        translate:{
            "逆天运气":"逆天运气",
            "逆天运气_info":"你的回合开始，最多可以弃置两张牌。若弃置一张，从牌堆中获得一张你指定的基本牌；若弃置两张，从牌堆中获得一张你指定的基本牌和一张你指定的锦囊牌。牌堆中每没有一张你指定的牌，你摸两张牌。",
            "监管者鸡龙":"监管者鸡龙",
            ...
            "冯冯杀":"冯冯杀",
            "冯冯杀_info":"每轮开始时，你可以将【监管者鸡龙】修改：1.反转比较（小于变大于），2.移除回合开始判定，3.移除回合结束判定。",
            "辨忠奸":"辨忠奸",
            "辨忠奸_info":"游戏开始时，你选择一名玩家，令其获得以下两个技能之一：1.【护忠】其每回合至多受到1点伤害，你对其造成的伤害无效，你与其各摸两张牌；2.【诛奸】其受到你造成的伤害+1，其每受到1点伤害你摸两张牌，其死亡后若为忠臣你减1点体力上限，若为反贼你摸三张牌并加1点体力上限。",
            "护忠":"护忠",
            "护忠_info":"每回合至多受到1点伤害。“天赐”对你造成的伤害无效，每次防止伤害时双方各摸两张牌。",
            "诛奸":"诛奸",
